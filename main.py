...
adv_bool = False
adv_sign = "\U0001F50B رویداد مسئله محور هوشبات \U0001F9E0 دانشگاه فردوسی مشهد \U0001F393 اطلاعات بیشتر در کانال تلگرامی HooshBatt \U0001F916"
# Define develooper based on protocol type
reality_adv_sign, vless_adv_sign, vmess_adv_sign, trojan_adv_sign, shadowsocks_adv_sign = create_title(adv_sign, port = 2080)

# Define Donating row
dnt_bool = True
dnt_sign = "\U00002764\U0000fe0f DONATE-SPONSORING \U0001f31f DARAMET.COM/SOROUSHMIRZAEI \U0001f381"
# Define develooper based on protocol type
